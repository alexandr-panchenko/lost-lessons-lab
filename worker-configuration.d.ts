/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: ac3113e1bac4e9137c5fcdbfce739e80)
// Runtime types generated with workerd@1.20260714.1 2026-07-21
interface __BaseEnv_Env {
	MEDIA: R2Bucket;
	ROOM_CREATE_RATE_LIMITER: RateLimit;
	AI_REQUEST_RATE_LIMITER: RateLimit;
	OPENAI_MODEL: string;
	AI_ENABLED: string;
	APP_ENV: string;
	PUBLIC_APP_ORIGIN: string;
	PUBLIC_SUPPORTING_SCENARIOS_ENABLED: string;
	AI_TIMEOUT_MS: string;
	AI_MAX_RETRIES: string;
	AI_ROOM_LIMIT_PER_HOUR: string;
	AI_IP_LIMIT_PER_HOUR: string;
	ROOM_CREATE_IP_LIMIT_PER_HOUR: string;
	MAX_MEDIA_BYTES: string;
	MAX_MEDIA_EDGE_PX: string;
	ANALYSIS_MEDIA_EDGE_PX: string;
	GIT_COMMIT_SHA: string;
	SUBMISSION_TAG: string;
	ROOM_TOKEN_PEPPER: string;
	OPENAI_API_KEY: string;
	ROOMS: DurableObjectNamespace<import("./src/worker/index").RoomDurableObject>;
	ANALYSIS_WORKFLOW: Workflow<Parameters<import("./src/worker/index").AnalysisWorkflow['run']>[0]['payload']>;
}
