...
| M5 — Complete hero and judge flow | in progress | M3–M4 production prerequisites are green on 2026-07-21 | Achievements, prepared editable judge work, correction affordance, reset, and full wrong-to-correct production path remain | Implement only the documented M5 scope | — |
