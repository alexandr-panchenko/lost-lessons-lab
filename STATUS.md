...
| M7 — Visual polish and accessibility | in progress | M6 baseline is green on local, CI, and production gates as of 2026-07-21 | Must not change the verified hero timing or deterministic logic | Audit and polish hierarchy, keyboard access, live status, responsive layouts, reduced motion, sound gating, and original assets | — |
