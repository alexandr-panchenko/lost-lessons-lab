...
| M9 — Evidence and release freeze | not started | — | Public video URL, private `/feedback` Session ID, Devpost draft/track, and owner dashboard confirmations are external prerequisites | Prepare truthful final materials, then freeze the exact release after owner evidence is available | — |
