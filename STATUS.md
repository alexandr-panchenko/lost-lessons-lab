...
| M3 — Realtime canvas and deterministic bridge | in progress | On 2026-07-21, local gate passed 18 unit, 9 Worker/DO integration, build, and 11 Chromium E2E tests across realtime, reconnect, physics, replay, reload, responsive, and reduced-motion paths | Production still runs M2 | Commit, push, deploy, and verify M3 in production | — |
